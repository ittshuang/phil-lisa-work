...
**********************************************************************************
* Irene's exploration on 2004 HH data - IT spending
**********************************************************************************
* Site Communications Summary Table - all long distance expenditure
import delimited "${fpath1_1}\USA_2004\Hist2004_COMM.txt", clear 
sum ldexp ldoutexp ldinexp ldtotintexp ldtotdomexp

* Additional Business Demographics Table - white collar & desk worker number might be useful?
import delimited "${fpath1_1}\USA_2004\Hist2004_ADVECON.txt", clear 
sum whitcworker deskworker

* Enterprise - Information about the sites' parent company: emp, sales, loc etc
import delimited "${fpath1_1}\USA_2004\Hist2004_CORP.txt", clear 

* Enterprise Technology Totals - firm level data
import delimited "${fpath1_1}\USA_2004\Hist2004_CORPTOTALS.txt", clear 

* Product Table for site-level data
import delimited "${fpath1_1}\USA_2004\Hist2004_SYSTEM.txt", clear 
sum 
